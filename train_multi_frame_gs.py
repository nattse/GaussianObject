...
def training(args, datasets, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    """
    ...
    """
    first_iter = 0
    tb_writer = prepare_output_and_logger(datasets, './output/multiframe', args.log_name)
    frameData = []
    ...
    for iteration in range(first_iter, opt.iterations + 1):  
        ...
        for gaussians, scene in frameData:
...
if __name__ == "__main__":
    ...
    if len(args.frame_sequence) > 0:
        ...
        for frame in args.frame_sequence:
